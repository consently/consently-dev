...
- Use `Cmd+F` (Mac) or `Ctrl+F` (Windows) to search this index
- Check the [Getting Started](./setup/) section for onboarding
- Check [Implementation Guides](./guides/) for step-by-step instructions
- Check [Bug Fixes](./fixes/) if you're troubleshooting issues
...
2. Place fixes in `docs/fixes/`
3. Place summaries in `docs/summaries/`
4. Run `npm run organize-docs` to regenerate the index
