...
const taglines = [
  {
    text: '🇮🇳 Made for India, Built for Bharat',
    icon: <Shield className="h-5 w-5" />,
    gradient: 'from-orange-500 to-orange-600',
  },
  {
    text: '🚀 Pre-Launch Offer: 1 Month Free Trial',
    icon: <Rocket className="h-5 w-5" />,
    gradient: 'from-blue-500 to-blue-600',
  },
  {
    text: '✨ DPDPA 2023 Compliance Made Simple',
    icon: <Sparkles className="h-5 w-5" />,
    gradient: 'from-purple-500 to-purple-600',
  },
  {
    text: '⚡ 22 Indian Languages • Zero Hassle',
  ...
  {
    text: '📈 Scale Your Privacy Compliance Today',
    icon: <TrendingUp className="h-5 w-5" />,
    gradient: 'from-pink-500 to-pink-600',
  },
  {
    text: '🛡️ Privacy First, India First',
    icon: <Shield className="h-5 w-5" />,
    gradient: 'from-indigo-500 to-indigo-600',
  },
  {
    text: '💎 Enterprise-Grade Security, Startup-Friendly',
    icon: <Sparkles className="h-5 w-5" />,
